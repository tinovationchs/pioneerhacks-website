...
<div class="grid grid-cols-8 gap-8">
  ...
  {#each events as event}
    ...
    <!-- Timeline Graphics -->
    <div class="col-span-1 flex items-center w-full h-48">
      <div class="h-[90%] w-1 bg-secondary"></div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        class="w-16 h-16 fill-secondary">
    ...
    <div class="col-span-5 w-full indicator my-4">
      <span class="indicator-item indicator-center badge badge-secondary">{event.indicator}</span>
      <div class="card w-full bg-stone-300 shadow-xl">
        <div class="card-body">
          <!-- Title -->
          <h2 class="card-title">
            {event.title}
