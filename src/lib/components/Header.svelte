<header class="mb-10">
  ...
  <div class="h-2/3 w-full rounded-lg border-gray-500">
  ...
  <!-- Smoke -->
  <g stroke="#eee" stroke-width="5" fill="black">
  ...
  <!-- Stars -->
  <g transform="translate(850 300) scale(3)" fill="black" stroke="#eee">
  ...
  <!-- Text -->
  <text x="10" y="100" textLength="400" font-size="4rem">PioneerHacks</text>
  <text fill="#94d2d4" x="430" y="100" font-size="5rem" class="font-extrabold">V</text>

</svg>
  </div>

  <div
    class="flex flex-col items-center gap-2 text-center font-mono text-lg sm:flex-row sm:justify-between md:text-2xl">
